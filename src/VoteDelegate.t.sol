...
contract VoteDelegateTest is DSTest {
    ...
    function setUp() public {
        ...
        // Give us admin access to mint GOV
        hevm.store(
            address(gov),
            bytes32(uint256(4)),
    ...
    function test_proxy_lock_free() public {
        uint256 currGOV = gov.balanceOf(address(chief));
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + 100 ether);
        ...
        assertEq(gov.balanceOf(address(delegate)), 100 ether);
        assertEq(gov.balanceOf(address(chief)), currGOV);
        assertEq(iou.balanceOf(address(delegate)), 0);
    ...
    function test_proxy_lock_free_around_expiration() public {
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + 10 ether);
    ...
    function test_delegator_lock_free() public {
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + 10_000 ether);
    ...
    function test_delegator_lock_free_fuzz(uint256 wad_seed) public {
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + wad);
    ...
    function test_delegate_voting() public {
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + 10_100 ether);
    ...
    function test_delegate_voting_fuzz(uint256 wad_seed, uint256 wad2_seed) public {
        ...
        assertEq(gov.balanceOf(address(chief)), currGOV + wad + wad2);
    ...
    function testFail_delegate_attempts_steal() public {
        ...
        // Attempting to steal more GOV than you put in
